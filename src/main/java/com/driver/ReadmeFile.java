...
public class ReadmeFile {
   // Watchlist
//    You are a big time cinephile and you want to maintain a watchlist by making a simple spring boot
//    application to perform basic CRUD operations to maintain your movie records. So there are 3 major
//    ways you want to add new records. One way is to add a movie you really want to watch, another way
//    is to add a new director you discovered and want to explore his work, and a third way is you want
//    to add a movie-director pair.
//
//    Requirements of the application:
//    Make an MVC architecture, with Movie and Director as your only model classes, which will have some
//    fields as their properties, constructors and getters-setters. Then make a controller, service and
//    repository class with appropriate annotations. Since you want to keep it simple, you don’t need to
//    use any database. (Hint: Think HashMap(s))
//
...
//    Movie.java - String name, int durationInMinutes, double imdbRating, no-args constructor, all-args
//    constructor and getters-setters
//    Director.java Class - String name, int numberOfMovies, double imdbRating, no-args constructor,
//    all-args constructor and getters-setters
//
//    Note:
//
//    Use ResponseEntity object to return the required objects in the controllers
//    Make sure you follow the requirements for the controller very very carefully or your application
//    will give compilation error while running against hidden test cases
